...
public class FabrikTest
{
    ...
    public void TestBestellungAusgeben(){
        ...
        assertEquals("Bestellnummer:"+1+"\nStühle bestellt:"+2+"\nSofas bestellt:"+3+"\nIhre Lieferzeit beträgt: 1.0 Tag(e), 4.0 Stunden",fabrik.gibBestellungen().get(0).toString());
        assertEquals("Bestellnummer:"+2+"\nStühle bestellt:"+6+"\nSofas bestellt:"+6+"\nIhre Lieferzeit beträgt: 1.0 Tag(e), 9.0 Stunden",fabrik.gibBestellungen().get(1).toString());
    }
